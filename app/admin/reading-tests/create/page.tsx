...
import ReadingTestForm from '@/components/admin/ReadingTestForm'
...
export default function CreateReadingTestPage() {
  ...
  const loadFromJson = async () => {
    if (!confirm('Are you sure you want to load data from reading-test-data.json? This will create a new reading test with all passages and questions.')) {
      return
    }
    ...
    try {
      ...
      setMessage({
        type: 'success',
        text: `Reading test "${result.readingTest?.title || 'Untitled'}" created successfully! Redirecting...`
      })

      // Redirect to the reading tests list after a short delay
      setTimeout(() => {
      ...
      <div className="md:flex md:items-center md:justify-between">
        <div className="flex-1 min-w-0">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Create a new IELTS reading test with passages and questions. You can either fill out the form manually or load from the JSON file.
          </p>
        </div>
