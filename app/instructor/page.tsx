  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">Grade student submissions and provide feedback</p>
      </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">
                    {pendingSubmissions.filter(s => s.status === 'IN_PROGRESS').length}
                  </dd>
                </dl>
              </div>
            </div>
