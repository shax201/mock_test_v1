...
interface InstructorDashboardClientProps {
  ...
  initialRecentSubmissions: RecentSubmission[]
  error: string
}

export default function InstructorDashboardClient({ initialStats, initialRecentSubmissions, error }: InstructorDashboardClientProps) {
  const stats = initialStats
  const recentSubmissions = initialRecentSubmissions
