...
interface CompletedSubmissionsClientProps {
...
export default function CompletedSubmissionsClient({ initialSubmissions, error: initialError }: CompletedSubmissionsClientProps) {
  ...
  const filteredSubmissions = useMemo(() => {
    ...
    return submissions.filter(s => s.moduleType === filter)
  }, [submissions, filter])
  ...
  const handleFilterChange = (newFilter: FilterType) => {
    ...
    router.push(`/instructor/completed?${params.toString()}`)
  }
