...
interface PendingSubmissionsClientProps {
...
export default function PendingSubmissionsClient({ initialSubmissions, error: initialError }: PendingSubmissionsClientProps) {
  ...
  const handleFilterChange = (newFilter: FilterType) => {
    ...
    router.push(`/instructor/pending?${params.toString()}`)
  }
