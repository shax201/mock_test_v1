...
interface ParticipationHistoryClientProps {
  initialHistory: ParticipationHistoryItem[]
  initialSummaryStats: SummaryStats
  error: string
}

export default function ParticipationHistoryClient({
  initialHistory,
  initialSummaryStats,
  error: initialError
}: ParticipationHistoryClientProps) {
  const [history] = useState<ParticipationHistoryItem[]>(initialHistory)
  const [summaryStats] = useState<SummaryStats>(initialSummaryStats)
